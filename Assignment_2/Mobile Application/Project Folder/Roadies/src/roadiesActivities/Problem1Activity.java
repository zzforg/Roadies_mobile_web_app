...
/**
 * 
 * @author Dean Chen Create a problem listview activity, after that, problem
 *         chosen is recorded and a new page of details relating to this problem
 *         will be open.
 * 
 */
public class Problem1Activity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (item.equals(values[0])) {
			String[] narrowItems = new String[] { "Lagging", "Failure",
					"Brake Oil Leaking" };
